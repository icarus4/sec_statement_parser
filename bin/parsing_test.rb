...
DATA_SOURCE_FILE = 'bin/output/list_of_xbrl_link.json'
OUTPUT_STATEMENT_FILE = 'bin/output/parsing_test_results.json'
OUTPUT_FAILED_STATEMENT_FILE = 'bin/output/parsing_test_failed_stocks.txt'
